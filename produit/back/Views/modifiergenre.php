	...
	<div class="tm-page-wrap mx-auto">
        ...
        <form action="" method="POST">
            <table border="1" align="center">
                <tr>
                    <td>
                        <label for="idGenre">Numéro Genre:
                        </label>
                    </td>
                    <td><input type="text" name="idGenre" id="idGenre" value="<?php echo $genre['idGenre'];  ?>" readonly ></td>
                </tr>
				<tr>
                    <td>
                    ...
                    <td><input type="text" name="genrename" id="genrename" value="<?php echo $genre['genrename']; ?>" ></td>
                </tr>                            
                <tr>
                    <td></td>
                    <td>
