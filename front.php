<!DOCTYPE html>
<html lang="en">
<?php include '../Controller/aticketC.php'; ?>
<head>
	...
	<div class="tm-page-wrap mx-auto">
		<div class="position-relative">
            ...
            <form method="GET" align="center">
                <input class="controle" type="search" name="s" placeholder="Rechercher un utilisateur" required maxlength="20">
            ...
            ?>
            		<center><h1>Liste des film</h1></center>
                <table border="0" align="center">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="ajoutpanier.php?idticket=<?php echo $aticket['idticket']; ?>">Ajouter au panier</a>
                        </td>
                    </tr>
                </table>
                <?php } ?>
